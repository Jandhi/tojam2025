...
var copy2 = "When she re-emerged. She wore a crown and wielded a dreadful staff. Strange artifacts taken from deeper in the dungeon than anyone had ever gone before."
...
func show_frame2():
	...
	var length = 10.0
	my_tween = get_tree().create_tween().set_parallel(true)
	my_tween.tween_property(frame, "position", Vector2(150, 30), length)
